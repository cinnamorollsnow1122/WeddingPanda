...
public class BudgetExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private HashMap<String, List<Budget.ItemCategory>> _listDataChild;

    public BudgetExpandableListAdapter(Context context, List<String> listDataHeader,
                                       HashMap<String, List<Budget.ItemCategory>> listChildData) {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        final Budget.ItemCategory childText = (Budget.ItemCategory) getChild(groupPosition, childPosition);
